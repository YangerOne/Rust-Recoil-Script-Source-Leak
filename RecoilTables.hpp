...
public:
    ...
    static std::vector<vec1> Recoil_M249;
    static std::vector<vec1> Recoil_Python;
    static std::vector<vec1> Recoil_M92;
    static std::vector<vec1> Recoil_M39;
    static std::vector<vec1> Recoil_Rev;
...
struct {
    const double Delay = 133.3333;//133.333333333
}AK47;
struct {
    const int Delay = 120;
}LR300;
