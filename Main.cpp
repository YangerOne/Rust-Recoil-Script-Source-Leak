#include "Main.hpp"
#include "other/json/json.h";
#include "other/curl/curl.h";
            ...
            if (Includes::showing)
            {
                ImGui::Begin("##MegaSus", &loader_active, ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_HorizontalScrollbar | ImGuiWindowFlags_NoCollapse);
                {
                    ...
                    case 0:
                        ...
                        ImGui::BeginChild("Welcome to a pasted script", ImVec2(168, 234));
                        {
                            ImGui::BeginGroup();
                    ...
                    case 2:
                        ...
                        ImGui::BeginChild("recoil", ImVec2(342, 238));
                        {
                            ...
                            ImGui::Text("Weapon");
                            ImGui::SameLine();
                            ImGui::Combo("##W", &Includes::selectedItemWP, Script::itemWP, 12);
                            ImGui::Text("Scopes  ");
                            ImGui::SameLine();
                            ImGui::Combo("##S", &Includes::selectedItemSC, Script::itemSC, 5);
                            ImGui::Text("Barrels  ");
                            ImGui::SameLine();
                            ImGui::Combo("##B", &Includes::selectedItemBR, Script::itemBR, 4);
                            ImGui::Text("Randomize X");
                            ImGui::SameLine();
                            ImGui::SliderFloat("##X", &Includes::XCONTROL, 1, 5, "% .2f");
                            ImGui::Text("Randomize Y");
                            ImGui::SameLine();
                            ImGui::SliderFloat("##Y", &Includes::YCONTROL, 1, 5, "% .2f");
                    ...
                    case 3:
                        ...
                        ImGui::BeginChild("misc", ImVec2(342, 238));
                        {
                            ...
                            ImGui::Checkbox("rapid fire", &Includes::bRapidf);
